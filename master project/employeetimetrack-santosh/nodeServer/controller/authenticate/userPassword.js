...
const getUserWithPassword = function (username) {
    const query = "SELECT `user`.`id`, `user`.`firstname`, `user`.`lastname`, `user`.`username`, `user`.`email`, `user`.`lastSignIn`, `user`.`active`, `user`.`failedAttempts`, `user`.`lastFailedAttempts`,\
